...
from Settings.SettingsHTRU import Settings
...
def main():
    best_params = pd.DataFrame(
        [['Gaussian Progressive', 7, 'Center'], ['Gaussian Progressive', 5, 'Center'], ['Gaussian Equal', 7, 'Center'],
         ['Gaussian Progressive', 9, 'Center']],
    ...
    for _, data in best_params.iterrows():
        ...
        results.to_csv(r'Test - Datasets\ResultsIT2\HTRUSigmaCenterKFoldGrid' + str(i) + '.csv', index=None)
        i += 1

    results.to_csv(r'Test - Datasets\ResultsIT2\HTRUSigmaCenterKFoldGrid.csv', index=None)
