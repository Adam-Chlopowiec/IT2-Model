...
class Fuzzifier(object):
    ...
    def numbersToRowSets(self, idx, values, mean):
        ...
        print("Sigma w numbersToRowSets: {}".format(sigma))
        ...
        if self.settings.gausses == 3:
            ...
            print("Sigma przy cr_low w gauss5: {}".format(sigma))
            ...
            print("Sigma przy cr_middle w gauss5: {}".format(sigma))
            ...
            print("Sigma przy cr_low w gauss7: {}".format(sigma))
            ...
            print("Sigma przy cr_middlelow w gauss5: {}".format(sigma))
            ...
            print("Sigma przy cr_middle w gauss7: {}".format(sigma))
            ...
            print("Sigma przy cr_middlehigh w gauss7: {}".format(sigma))
            ...
            print("Sigma przy cr_low w gauss9: {}".format(sigma))
            ...
            print("Sigma przy cr_middlelowminus w gauss9: {}".format(sigma))
            ...
            print("Sigma przy cr_middlelow w gauss9: {}".format(sigma))
